...
/* Always include libssh2_config.h for ESP32 platforms */
...
/* ESP32 specific configuration - config already included */
#elif defined(ESP32) || defined(ARDUINO_ARCH_ESP32) || defined(CONFIG_IDF_TARGET_ESP32)
